...
var Controller = function Controller(db,table) {
	...
	this.delete = [this.deleteGenerator()]
	this.load = this.loadGenerator();
};

Controller.prototype.loadGenerator = function() {
	var self = this;
	return function(req,res,next,id) {
		self.table.find(id).complete(function(err,rec) {
...
Controller.prototype.deleteGenerator = function() {
	var self = this;
